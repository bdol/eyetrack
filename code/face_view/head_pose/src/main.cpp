...
#define INCLUDE_ERROR_ESTIMATE false
...
int main(int argc, const char * argv[]) {
    ...
    string output_file_path = "/fiddlestix/Users/varsha/Documents/ResearchEyetrackCode/eyetrack/all_images/table_top_training_0/k1_png/head_pose_output.txt";
    string input_file_path = "/fiddlestix/Users/varsha/Documents/ResearchEyetrackCode/eyetrack/all_images/table_top_training_0/k1_png/depth_file_list.txt";
    ...
    while (fin.good()) {
        ...
        //        cout<<"File ext raw? : "<<is_raw<<endl;
        //        cout<<current_board_number<<endl;
        fout << depth_file_name << ",";

        if (file_open && (current_board_number != -1 && INCLUDE_ERROR_ESTIMATE)) {
            cout << "Including error estimate" << endl;
        ...
        else if (file_open && !INCLUDE_ERROR_ESTIMATE) {
            cout << "Not including error estimate" << endl;
            // run head pose estimation
            get_head_pose_estimate(depth_mat);
            // write to file if valid pose is returned
            if (g_means.size() > 0) {
