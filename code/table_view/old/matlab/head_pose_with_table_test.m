...
fclose(fid);
head_center_3d = zeros(3, length(C_data0{1}));
head_front_3d = zeros(3, length(C_data0{1}));
head_pose_direction = zeros(3, length(C_data0{1}));
for i = 1:length(C_data0{1})
    ...
    [head_center_3d(1,i) head_center_3d(2,i), head_center_3d(3,i)] = deal(C_data0{5}(i), C_data0{6}(i), C_data0{7}(i));
    g_face_dir = [0;0;-1];
    ...
    [head_pose_direction(1,i) head_pose_direction(2,i) head_pose_direction(3,i)] = deal(g_face_curr_dir(1), g_face_curr_dir(2), g_face_curr_dir(3));
    % 150 is an arbit length for the vector
    head_front = head_center_3d(:,i) + 200*g_face_curr_dir;
    [head_front_3d(1,i) head_front_3d(2,i), head_front_3d(3,i)] = deal(head_front(1), head_front(2), head_front(3));
...
% convert to meters
head_center_3d = head_center_3d./1000;
head_front_3d = head_front_3d./1000;
...
head_pose_table_intersection = vector_plane_intersection(table_plane_k1, ...
    head_center_3d(:,k1_image_idx), head_pose_direction(:,k1_image_idx));
...
line([head_center_3d(1,k1_image_idx) head_front_3d(1,k1_image_idx)], ...
    [head_center_3d(2,k1_image_idx) head_front_3d(2,k1_image_idx)], ...
    [head_center_3d(3,k1_image_idx) head_front_3d(3,k1_image_idx)], ...
    'LineWidth', 3, 'Color', 'y');
plot3(head_center_3d(1,k1_image_idx), head_center_3d(2,k1_image_idx), ...
    head_center_3d(3,k1_image_idx), 'r*', 'MarkerSize', 20);
plot3(head_front_3d(1,k1_image_idx), head_front_3d(2,k1_image_idx), ...
    head_front_3d(3,k1_image_idx), 'g*', 'MarkerSize', 20);
plot3(head_pose_table_intersection(1), head_pose_table_intersection(2), ...
    head_pose_table_intersection(3), 'c*', 'MarkerSize', 30);
view([-67 -32]);
axis equal;
grid on
