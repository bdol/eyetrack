function [r_eye, l_eye, r_eye_rect, l_eye_rect, c_trans_r, c_trans_l cr, cl] = rectify_eyes_center_first(canon_corresp, turned_corresp, w, h, im_canon, im_turned)
...
cent_turned_r = mean(X_t_r);
cent_turned_l = mean(X_t_l);
dc_r = cent_r - cent_turned_r;
dc_l = cent_l - cent_turned_l;
X_t_r = bsxfun(@minus, X_t_r, dc_r);
X_t_l = bsxfun(@minus, X_t_l, dc_l);
