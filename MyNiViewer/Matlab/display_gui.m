...
set(handles.depth,'NextPlot','add');
handles.number_index = 0;
handles.burst_index = 0;
...
% update image index
if(handles.burst_index>1)
    handles.burst_index = handles.burst_index - 1;
else
    handles.number_index = handles.number_index - 1;
    handles.burst_index = 3;
end
if(handles.number_index>0)
    [handles.rgb_image handles.depth_image] = display_images(handles.number_index, handles.burst_index);
...
% Update image index
handles.burst_index = mod(handles.burst_index + 1, 4);
if(handles.burst_index<1)
	handles.number_index = handles.number_index + 1;
    handles.burst_index = 1;
end
if(handles.number_index < 1)
    handles.number_index = 1;
end
[handles.rgb_image handles.depth_image] = display_images(handles.number_index, handles.burst_index);
if(length(handles.rgb_image)>0)
    set(handles.rgb,'NextPlot','add');
